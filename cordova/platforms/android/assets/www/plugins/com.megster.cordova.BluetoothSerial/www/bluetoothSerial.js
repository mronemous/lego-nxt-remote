cordova.define("com.megster.cordova.BluetoothSerial.bluetoothSerial", function(require, exports, module) {module.exports = {
    ...
    // writes data to the bluetooth serial port - data must be a base64 string or ArrayBuffer
    writeBinary: function (data, success, failure) {
        cordova.exec(success, failure, "BluetoothSerial", "writeBinary", [data]);
    },
